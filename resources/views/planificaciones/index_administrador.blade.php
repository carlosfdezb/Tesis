...
<section class="content container-fluid">
    <div class="row">
        <div class="col-md-12">
            {{ Form::open(['url' => 'planificaciones', 'method' => 'GET']) }}
                    ...
                    <div class="box-body">
                        <div class="box-tools">
                            ...
                            <div class="form-group col-md-4">
                                <input type="text" class="form-control" name="scope_nombre_profesor" placeholder="Nombre Profesor ">
                            </div>
                                ...
                                <tr>
                                   ...
                                   <!-- botones  -->
                                    <td>
                                        <div class="btn-group">
                                            <!-- principal  -->
                                            <a class="btn btn-flat" style="height: 34px; background-color: #EFEFEF ; color: #333" type="button" href="{{ route('planificaciones.administrativo.vista_profesor', ['id_profesor' => $profesor->id]) }}">
